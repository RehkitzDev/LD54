...
IUnknown_VTable :: struct {
	QueryInterface: proc "stdcall" (this: ^IUnknown, riid: ^IID, ppvObject: ^rawptr) -> windows.HRESULT,
	AddRef:         proc "stdcall" (this: ^IUnknown) -> windows.ULONG,
	Release:        proc "stdcall" (this: ^IUnknown) -> windows.ULONG,
}
...
IPropertyStore_UUID := &IID{0x886d8eeb, 0x8cf2, 0x4446, {0x8d, 0x02, 0xcd, 0xba, 0x1d, 0xbd, 0xcf, 0x99}}
...
KSDATAFORMAT_SUBTYPE_IEEE_FLOAT := IID{0x00000003, 0x0000, 0x0010, {0x80, 0x00, 0x00, 0xAA, 0x00, 0x38, 0x9B, 0x71}}
WAVEFORMATEXTENSIBLE :: struct #packed{
    Format: WAVEFORMATEX,
    Samples: windows.WORD,
    dwChannelMask: windows.DWORD,
    SubFormat: windows.GUID,
}

IAudioClient_VTable :: struct {
    using iunknown_vtable: IUnknown_VTable,
    Initialize: proc "stdcall" (this: ^IAudioClient, ShareMode: AUDCLNT_SHAREMODE, StreamFlags: u32, hnsBufferDuration: REFERENCE_TIME, hnsPeriodicity: REFERENCE_TIME, pFormat: rawptr, AudioSessionGuid: windows.LPCGUID) -> windows.HRESULT,
...
IAudioClient2_UUID := &IID{0x726778CD, 0xF60A, 0x4eda, {0x82, 0xDE, 0xE4, 0x76, 0x10, 0xCD, 0x78, 0xAA}}
...
IAudioClient3_UUID := &IID{0x7ED4EE07, 0x8E67, 0x4CD4, {0x8C, 0x1A, 0x2B, 0x7A, 0x59, 0x87, 0xAD, 0x42}}
...
IAudioRenderClient_VTable :: struct {
    ...
    ReleaseBuffer: proc "stdcall" (this: ^IAudioRenderClient, NumFramesWritten: windows.UINT32, dwFlags: u32) -> windows.HRESULT,
}
